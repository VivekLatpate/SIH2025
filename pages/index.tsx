...
export default function HomePage() {
  const [currentPage, setCurrentPage] = useState<'home' | 'digital-ids' | 'verify-id' | 'safe-booking' | 'emergency-alerts' | 'places-near-me'>('home')
  ...
  ], [handleDigitalIDClick, handleVerifyIDClick, handleSafeBookingClick, handleEmergencyAlertsClick])
            ...
            <Sidebar 
              ...
              solutions={solutions.map(({ id, title, icon }: Solution) => ({ 
                ...
                onClick: id === 'digital-ids' ? handleDigitalIDClick : 
                         ...
                         id === 'places-near-me' ? handlePlacesNearMeClick : undefined
              }))} 
