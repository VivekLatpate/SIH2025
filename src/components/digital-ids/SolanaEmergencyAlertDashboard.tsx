                        ...
                        <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                          ...
                          <div className="space-y-2">
                            <div className="flex justify-between items-center">
                              ...
                              <span className="text-red-400 font-semibold">{stats.panicAlerts}</span>
                            </div>
                            <div className="flex justify-between items-center">
                              <span className="text-white/70 text-sm">Geo-fence Breaches</span>
                              <span className="text-orange-400 font-semibold">{stats.geofenceAlerts}</span>
                            </div>
                            <div className="flex justify-between items-center">
                              <span className="text-white/70 text-sm">Anomaly Detection</span>
                              <span className="text-yellow-400 font-semibold">{stats.anomalyAlerts}</span>
                            </div>
                          </div>
                        </div>
                        <div className="bg-white/5 rounded-lg p-4 border border-white/10">
